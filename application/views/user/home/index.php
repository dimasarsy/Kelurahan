    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/home/slide1.png" class="d-block w-100" alt="" style="max-height:700px; min-height:320px">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="card">
                <div class="card-body">
                    <a class="layanan" href="<?php base_url() ?>home">
                        ...
                        <p class="card-text">Dengan Informasi Layanan Warga Lebak Bulus dapat Melihat beberapa Lokasi Layanan yang tersebar</p>
                    </a>
                </div>
            </div>
            <div class="card">
